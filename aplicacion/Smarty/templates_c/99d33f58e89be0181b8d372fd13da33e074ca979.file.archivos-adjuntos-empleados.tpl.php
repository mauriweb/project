<?php /* Smarty version Smarty-3.1.12, created on 2014-01-18 12:28:59
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/archivos-adjuntos-empleados.tpl" */ ?>
<?php /*%%SmartyHeaderCode:209023367052a9ddf809ec25-62740821%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99d33f58e89be0181b8d372fd13da33e074ca979' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/archivos-adjuntos-empleados.tpl',
      1 => 1390044538,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '209023367052a9ddf809ec25-62740821',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52a9ddf80eb984_12568910',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a9ddf80eb984_12568910')) {function content_52a9ddf80eb984_12568910($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="page-container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Adjuntar archivos de empleados <small> Acero estudio</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
							<i class="inicio"></i>
							<a href="emmpleados">Empleados</a> 
							<i class="fa fa-angle-right"></i>
						</li>
						<li>
							Adjuntar archivos de empleados
						</li>
								...
								<div class="form-body">
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="category" class="select2me">
                                            	...
                                            	<option value="ES">Nombre de Empleado</option>
                                                <option value="ES">Nombre de Empleado</option>
                                                <option value="ES">Nombre de Empleado</option>
                                                <option value="ES">Nombre de Empleado</option>
                                                <option value="ES">Nombre de Empleado</option>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="category" class="select2me">
                                            	<option value="0">Seleccionar..</option>
                                            	<option value="ES">Curriculum</option>
                                                <option value="ES">Contrato laboral</option>
                                                <option value="ES">Partes de/para la S.Social</option>
                                                <option value="ES">Certificados IRPF</option>
											</select>
										</div>
									</div>
                                    <div class="form-group">
										<label class="control-label col-md-3">Fecha de inserción automaticamente</label>
										<div class="col-md-4">
											<span class="help-block">dd/mm/yyyy</span>
										</div>
									</div>	
                                   <div class="form-group">
										<label for="exampleInputFile" class="col-md-3 control-label">Archivo</label>
										<div class="col-md-9">
											<input type="file" id="exampleInputFile">
											<p class="help-block">Selecciona el PDF correspondiente</p>
										</div>
									</div>
								</div>
