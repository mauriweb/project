<?php /* Smarty version Smarty-3.1.12, created on 2014-04-30 17:16:34
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/trabajador/gastos.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29681738652e5939c0e4b48-48264222%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '524f5eeaa7bafc07e7a0f1c47f45752659c59fe6' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/trabajador/gastos.tpl',
      1 => 1397077179,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29681738652e5939c0e4b48-48264222',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52e5939c139dd3_07524310',
  'variables' => 
  array (
    'anyos' => 0,
    'proyectosHtml' => 0,
...
<?php if ($_valid && !is_callable('content_52e5939c139dd3_07524310')) {function content_52e5939c139dd3_07524310($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="page-container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Lista justificación de gastos <small> Acero estudio</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
							
							<a href="add-gastos-trabajador" class="btn red dropdown-toggle"><span style="color:#FFF;">Añadir justificación de gastos <i class="fa fa-plus"></i></span></a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">Justificación de gastos</div>
							<div class="tools">
						...
						<div class="portlet-body"><form id="filtro" method="post" action="gastos-trabajador">
                            ...
                            <div class="row">
                            	<div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                        <input class="form-control date-picker" placeholder="Fecha de" size="5" type="text" name="fechaDe" value="<?php echo $_smarty_tpl->tpl_vars['fechaDe']->value;?>
" />
                                        </div>
                                        <div class="col-md-2">
                                     ...
                                     <div class="col-md-12" style="margin-top:5px;">
                                        ...
                                        <div class="col-md-2">
                                        <input class="form-control date-picker" placeholder="Fecha a" size="5" type="text" name="fechaA" value="<?php echo $_smarty_tpl->tpl_vars['fechaA']->value;?>
" />
                                        </div>
                                        <div class="col-md-2">
                                        <button  class="btn dropdown-toggle green" id="excel" data-toggle="dropdown"><i class="fa fa-th"></i> Guardar Excel</button>
                                        </div>
                                     </div>
       ...
       <!-- =======================================
        ...
        <script>
            jQuery(document).ready(function() {       
			   ...
			   jQuery('#actualizar, #excel').click(function(){
				   jQuery('#excell').remove();												   
