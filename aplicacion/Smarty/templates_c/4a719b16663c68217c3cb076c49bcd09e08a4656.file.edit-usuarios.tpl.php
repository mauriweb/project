<?php /* Smarty version Smarty-3.1.12, created on 2014-01-30 15:43:01
         compiled from "C:\xampp\htdocs\acero\plantillas\tpl\admin\edit-usuarios.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2328152ea64f5f40175-80473144%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4a719b16663c68217c3cb076c49bcd09e08a4656' => 
    array (
      0 => 'C:\\xampp\\htdocs\\acero\\plantillas\\tpl\\admin\\edit-usuarios.tpl',
      1 => 1390650427,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2328152ea64f5f40175-80473144',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52ea64f610f470_54236959',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ea64f610f470_54236959')) {function content_52ea64f610f470_54236959($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="page-container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Editar usuarios <small>en la aplicación de Acero estudio</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">Editar usuarios</div>
						</div>
							...
							<form action="#" id="form_sample_1" class="form-horizontal form-bordered form-row-stripped">
								<div class="form-body">
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="category" class="select2me">
                                                ...
                                                <option value="ES">Pepe apellido apellido</option>
                                                <option value="ES">Pepe apellido apellido</option>
                                                <option value="ES">Pepe apellido apellido</option>
											</select>
										</div>
                                    ...
                                    <div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="99 9999999">
													</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="category" class="select2me">
                                                ...
                                                <option value="ES">Administración empresa</option>
                                                <option value="ES">Empresa externa (Visado)</option>
											</select>
										</div>
									</div>
								</div>
