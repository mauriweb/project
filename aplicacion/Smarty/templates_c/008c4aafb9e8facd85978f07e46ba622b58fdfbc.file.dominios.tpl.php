<?php /* Smarty version Smarty-3.1.12, created on 2013-04-30 19:10:41
         compiled from "/kunden/homepages/12/d236336551/htdocs/jenacherdesigner/plantillas/tpl/noticias/dominios.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1776400840517ffb11c82b75-11293781%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '008c4aafb9e8facd85978f07e46ba622b58fdfbc' => 
    array (
      0 => '/kunden/homepages/12/d236336551/htdocs/jenacherdesigner/plantillas/tpl/noticias/dominios.tpl',
      1 => 1367341778,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1776400840517ffb11c82b75-11293781',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_517ffb11ce5455_35292001',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_517ffb11ce5455_35292001')) {function content_517ffb11ce5455_35292001($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
" data-send="false" data-layout="box_count" data-width="450" data-show-faces="true"></div>
            ...
            <p>
           Un dominio o nombre de dominio es el nombre que identifica un sitio web. Cada dominio tiene que ser único en Internet. Por ejemplo, "www.jnacher.com" es el nombre de dominio de la página web de Jnacher. Un solo servidor web puede servir múltiples páginas web de múltiples dominios, pero un dominio sólo puede apuntar a un servidor.<br /><br />
Un dominio se compone normalmente de tres partes: en www.jnacher.com, las tres uves dobles (www), el nombre de la organización (jnacher) y el tipo de organización (com).<br /><br />
Los tipos de organización más comunes son .COM, .ES, y .ORG, que se refieren a comercial, españa y organización (originalmente sin ánimo de lucro, aunque ahora cualquier persona puede registrar un dominio .org).<br /><br />
Puesto que Internet se basa en direcciones IP, y no en nombres de dominio, cada servidor web requiere de un servidor de nombres de dominio (DNS) para traducir los nombres de los dominios a direcciones IP. <br />Cada dominio tiene un servidor de nombre de dominio primario y otro secundario.<br /><br />
En Jnacher estudio de diseño web & gráfico nos dedicamos a darle servicio de Dominio + Hosting, consultenos precios.<br />
