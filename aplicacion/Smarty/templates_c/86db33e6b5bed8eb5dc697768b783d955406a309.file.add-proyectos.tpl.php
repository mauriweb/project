<?php /* Smarty version Smarty-3.1.12, created on 2014-04-30 13:28:21
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/add-proyectos.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18053483252a89bb6b0c1f2-36263110%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '86db33e6b5bed8eb5dc697768b783d955406a309' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/add-proyectos.tpl',
      1 => 1394030042,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18053483252a89bb6b0c1f2-36263110',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52a89bb6b5a3a7_30404713',
  'variables' => 
  array (
    'idProy' => 0,
    'mensaje' => 0,
...
<?php if ($_valid && !is_callable('content_52a89bb6b5a3a7_30404713')) {function content_52a89bb6b5a3a7_30404713($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="page-container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Insertar proyectos <small> Acero estudio</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
							
							<a href="proyectos" class="btn red dropdown-toggle"><span style="color:#FFF;">Ver proyectos</span></a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">Insertar proyectos</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="add-proyectos" method="post" id="form_sample_1" class="form-horizontal form-bordered form-row-stripped">
                            <?php echo $_smarty_tpl->tpl_vars['idProy']->value;?>
                                ...
                                <?php echo $_smarty_tpl->tpl_vars['mensaje']->value;?>
                                	...
                                	<div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="frm-sede" class="select2me">
                                            	<option value="ES" <?php echo $_smarty_tpl->tpl_vars['ES']->value;?>
 >España</option>
                                                <option value="PE" <?php echo $_smarty_tpl->tpl_vars['PE']->value;?>
 >Perú</option>
											</select>
										</div>
									</div>
                                    <div class="form-group">
													<label  class="col-md-3 control-label ">Código del proyecto</label>
                                                    
                                                    <div class="col-md-4">
														<input type="text" class="form-control" placeholder="ej: 7401-DD-Kenya" name="frm-codigo" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['codigo'];?>
">
													</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="frm-idCliente" class="select2me">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" maxlength="200" name="frm-observaciones" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['observaciones'];?>
" id="maxlength_placement">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">Fecha entrada</label>
										<div class="col-md-9">
											<span class="help-block">
											La fecha se inserta automaticamente.
											</span>
										</div>
									</div>
								</div>
