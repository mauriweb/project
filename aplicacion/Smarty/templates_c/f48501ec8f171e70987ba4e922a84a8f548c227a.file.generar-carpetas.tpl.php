<?php /* Smarty version Smarty-3.1.12, created on 2014-04-30 17:09:48
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/generar-carpetas.tpl" */ ?>
<?php /*%%SmartyHeaderCode:195761689652e02d67843e21-83740321%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f48501ec8f171e70987ba4e922a84a8f548c227a' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/generar-carpetas.tpl',
      1 => 1391612492,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '195761689652e02d67843e21-83740321',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52e02d678954a5_71361155',
  'variables' => 
  array (
    'frmnombre' => 0,
    'mensaje' => 0,
...
<?php if ($_valid && !is_callable('content_52e02d678954a5_71361155')) {function content_52e02d678954a5_71361155($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="page-container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Insertar carpetas <small> Acero estudio</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">Insertar carpeta principal</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="generar-carpetas" method="post" id="form_sample_1" class="form-horizontal form-bordered form-row-stripped">
								<div class="form-body">
                                
                                    <div class="form-group">
													<label  class="col-md-3 control-label ">Nombre de carpeta</label>
                                                    <div class="col-md-4">
														<input type="text" class="form-control" name="frm-nombre" value="<?php echo $_smarty_tpl->tpl_vars['frmnombre']->value;?>
" placeholder="Nombre de carpeta">
            ...
            <div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">Insertar carpeta secundaria</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="generar-carpetas" method="post" id="form_sample_1" class="form-horizontal form-bordered form-row-stripped">
                                ...
                                <?php echo $_smarty_tpl->tpl_vars['mensaje']->value;?>
                                	...
                                	<div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control select2me" name="frm-idCarpetaPrin">
