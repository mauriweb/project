<?php /* Smarty version Smarty-3.1.12, created on 2014-04-30 16:39:24
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/add-tarifas.tpl" */ ?>
<?php /*%%SmartyHeaderCode:176845461952a8cc7f5bad31-56000314%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a58aae30135585f1599e6cb9cd9558fa9ed94d9d' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/add-tarifas.tpl',
      1 => 1395072170,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '176845461952a8cc7f5bad31-56000314',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52a8cc7f60c7d4_81224113',
  'variables' => 
  array (
    'idTar' => 0,
    'mensaje' => 0,
...
<?php if ($_valid && !is_callable('content_52a8cc7f60c7d4_81224113')) {function content_52a8cc7f60c7d4_81224113($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="page-container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Insertar tarifas <small> Acero estudio</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
							
							<a href="tarifas" class="btn red dropdown-toggle"><span style="color:#FFF;">Ver tarifas</span></a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">Insertar tarifas</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="add-tarifas" method="post" id="form_sample_1" class="form-horizontal form-bordered form-row-stripped">
                            <?php echo $_smarty_tpl->tpl_vars['idTar']->value;?>
								...
								<div class="form-body">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="frm-categoriaProfesional" class="select2me">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="frm-categoria">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">Código</label>
													<div class="col-md-4">
														<input type="text" class="form-control" name="frm-codigo" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['codigo'];?>
" placeholder="C0450">
													</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" maxlength="100" name="frm-descripcion" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['descripcion'];?>
" id="maxlength_placement">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">€</label>
													<div class="col-md-4">
														<input type="text" name="frm-euros" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['euros'];?>
