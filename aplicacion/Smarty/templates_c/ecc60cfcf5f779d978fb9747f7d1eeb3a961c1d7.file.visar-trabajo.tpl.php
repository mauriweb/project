<?php /* Smarty version Smarty-3.1.12, created on 2013-12-13 21:32:45
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/clienteVisado/visar-trabajo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:44123791552ab6eed5e2362-24065349%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ecc60cfcf5f779d978fb9747f7d1eeb3a961c1d7' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/clienteVisado/visar-trabajo.tpl',
      1 => 1386966736,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '44123791552ab6eed5e2362-24065349',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52ab6eed633ac7_52312012',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ab6eed633ac7_52312012')) {function content_52ab6eed633ac7_52312012($_smarty_tpl) {?><!DOCTYPE html>
...
<body class="page-header-fixed">
        ...
        <div class="page-container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Visar trabajo <small> Acero estudio</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
							
							<a href="proyectos-visado" class="btn red dropdown-toggle"><span style="color:#FFF;">Ver todos los trabajo</span></a>
			...
			<div class="tab-pane ">
								<div class="portlet box red">
									<div class="portlet-title">
										<div class="caption">Visar trabajo</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										...
										<form action="#" class="form-horizontal">
											<div class="form-body">
												<h3 class="form-section">Número del pedido</h3>      
												...
												<div class="row">
                                                    ...
                                                    <div class="col-md-3">
														 <div class="form-group">
                                                            <label  class="col-md-3 control-label">Visado</label>
                                                            <div class="col-md-9">
                                                                <div class="radio-list">
                                                                    <label>
                                                                    <input type="radio" name="optionsRadios2" id="optionsRadios22" value="option1" checked> Si
                                                                    </label>
                                                                    <label>
                                                                    <input type="radio" name="optionsRadios2" id="optionsRadios23" value="option2" checked> No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
	...
	<!-- END CONTAINER -->
       ...
       <!-- =======================================
        ...
        ======================================= -->
        <?php echo $_smarty_tpl->getSubTemplate ("clienteVisado/pie.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
