<?php /* Smarty version Smarty-3.1.12, created on 2014-04-30 17:21:00
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/clienteVisado/informes.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5893923452e598289ca0b4-35068788%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1c2164f7782d0a9f23514195eb5176e01294e3b' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/clienteVisado/informes.tpl',
      1 => 1397405690,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5893923452e598289ca0b4-35068788',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52e59828a21cd8_71137476',
  'variables' => 
  array (
    'cliente' => 0,
    'mensaje' => 0,
...
<?php if ($_valid && !is_callable('content_52e59828a21cd8_71137476')) {function content_52e59828a21cd8_71137476($_smarty_tpl) {?><!DOCTYPE html>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							<i class="inicio"></i>
							Informes avanzados <span style="font-size:16px; font-weight:bolder; ">PARTES DE TRABAJO</span>
						</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">Partes de trabajos, informes avanzados</div>
							<div class="tools">
						...
						<div class="portlet-body">
                         <form method="post" action="informes-trabajo-cliente" id="filtro" >
                        <?php echo $_smarty_tpl->tpl_vars['cliente']->value;?>
                            ...
                            <div class="row">
                            	<div class="col-md-12">
                                        <div class="col-md-2">
                                                    <select class="form-control select2me" name="idPedido" >
                                        ...
                                        <div class="col-md-2">
                                                    <select class="form-control select2me" name="idProyecto" >
                                        ...
                                        <div class="col-md-2">
                                                    <select class="form-control select2me" name="idEmpleado" >
...
" />
							...
							<table class="table table-striped table-bordered table-hover" id="sample_7">
								<thead>
									<tr>
										<th class="table-checkbox"><input type="checkbox" class="group-checkable" data-set="#sample_7 .checkboxes" /></th>
										<th>Nº Pedido</th>
                                        <th>Nº Parte</th>	
										<th>Proyecto</th>
                                        <th>Trabajador</th>
