<?php /* Smarty version Smarty-3.1.12, created on 2014-05-28 17:26:07
         compiled from "C:\xampp\htdocs\acero\plantillas\tpl\admin\codigo-material-insertar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1201652ea6738c50e97-06615498%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65e9da4f4c3daa6e1f621aa76afab0b6eb1a8bf3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\acero\\plantillas\\tpl\\admin\\codigo-material-insertar.tpl',
      1 => 1401290762,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1201652ea6738c50e97-06615498',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52ea6738d61df7_88557234',
  'variables' => 
  array (
    'mensaje' => 0,
    'tipos' => 0,
    'frmnumimpresiones' => 0,
    'frmpreciopresiones' => 0,
    'frmcodigo' => 0,
    'frmsector' => 0,
  ),
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ea6738d61df7_88557234')) {function content_52ea6738d61df7_88557234($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="page-container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Insertar código de material <small> Acero estudio</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
                    	<li class="btn-group">
							
							<a href="ver-codigo-material-insertar" class="btn red dropdown-toggle"><span style="color:#FFF;">Ver códigos</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">Insertar código</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="codigo-material-insertar" method="post" id="form_sample_1" class="form-horizontal">
								<div class="form-body">
                                <?php echo $_smarty_tpl->tpl_vars['mensaje']->value;?>
                                	...
                                	<div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="frm-tipo" id="tipos" class="select2me">
                                            	<option value="">Seleccionar...</option>
                                               <?php echo $_smarty_tpl->tpl_vars['tipos']->value;?>
                                     ...
                                     <div class="form-group rangos" style="display:none;">
													<label  class="col-md-3 control-label">Numero de Impresiones:</label>
													<div class="col-md-4">
														<input type="text" class="form-control rangos" name="frm-numImpresiones" value="<?php echo $_smarty_tpl->tpl_vars['frmnumimpresiones']->value;?>
" >
													...
													<div class="col-md-4">
                                                        ...
                                                        <input type="text" class="form-control rangos" name="frm-precioImpresiones" value="<?php echo $_smarty_tpl->tpl_vars['frmpreciopresiones']->value;?>
" >
													</div>
									</div>
                                    ...
                                    <div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="frm-codigo" value="<?php echo $_smarty_tpl->tpl_vars['frmcodigo']->value;?>
" placeholder="C000">
													</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" maxlength="150" name="frm-sector" value="<?php echo $_smarty_tpl->tpl_vars['frmsector']->value;?>
       ...
       <!-- =======================================
        ...
        <script>
            jQuery(document).ready(function() {       
			   ...
			   jQuery('#tipos').change(function(){
			   		if($(this).val()=='impresion'){
						$('.rangos').css('display','inherit');
					}else{
