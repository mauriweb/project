<?php /* Smarty version Smarty-3.1.12, created on 2014-05-27 17:27:15
         compiled from "C:\xampp\htdocs\acero\plantillas\tpl\admin\alta-parte-de-trabajo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:906252cc4534d3d5e3-24993220%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5ed6dc5148a5376c3952b3d0e4f98c6f06410d29' => 
    array (
      0 => 'C:\\xampp\\htdocs\\acero\\plantillas\\tpl\\admin\\alta-parte-de-trabajo.tpl',
      1 => 1401204392,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '906252cc4534d3d5e3-24993220',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52cc4535058dc2_77658968',
  'variables' => 
  array (
    'idTra' => 0,
    'filasDeMas' => 0,
...
<?php if ($_valid && !is_callable('content_52cc4535058dc2_77658968')) {function content_52cc4535058dc2_77658968($_smarty_tpl) {?><!DOCTYPE html>
			...
			<div class="tab-pane ">
								<div class="portlet box red">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="alta-parte-de-trabajo" method="post" id="form_sample_1" class="form-horizontal form-bordered form-row-stripped">
                                                                ...
                                                                <table class="table table-bordered table-striped table-condensed flip-content">
                                                                    ...
                                                                    <tbody id="append">
                                                                        <tr id="aClonar">
                                                                            ...
                                                                            <td>
                                                                                <input class="pedidoPor" name="det-idPedidoPor-1" id="det-idPedidoPor-1">
                                                                            </td>
                                                                            <td>
            ...
            jQuery(document).ready(function() {       
			  ...
			  var prevButton=Array();
  			  function addClon(pos){ 
				 ...
				 aClonar.find('.fecha').datepicker({ rtl: App.isRTL(),autoclose: true, format: 'dd/mm/yyyy' })
