<?php /* Smarty version Smarty-3.1.12, created on 2013-04-07 17:05:22
         compiled from "C:\xampp\htdocs\proyecto\plantillas\tpl\brief-web.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15685156d8ff183e67-13068312%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'adf10a2ecb0e80fd3fff76fe4998a9aff7f95242' => 
    array (
      0 => 'C:\\xampp\\htdocs\\proyecto\\plantillas\\tpl\\brief-web.tpl',
      1 => 1365347113,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15685156d8ff183e67-13068312',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5156d8ff265874_92932133',
  'variables' => 
  array (
    'titulo' => 0,
    'DOMINIO' => 0,
...
<?php if ($_valid && !is_callable('content_5156d8ff265874_92932133')) {function content_5156d8ff265874_92932133($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="contenedorUno" id="third">
	<div class="contenedor">
			...
			<br />
     		<h2 style="padding-left:20px; color:#EEAF00;">BRIEF PARA PROYECTOS WEB COORPORATIVOS</h2>
 ...
 <!-- -->
 <form style="float:left;" METHOD="post" action="/brief-web" enctype="multipart/form-data" class="contacto" onSubmit="return compForm()"> 
...
<div class="presupuesto_pasos paso_primero">
 ...
 name="ch_En_idioma_quiere_la_web_9" value="Otros" />Otros</label>
   ...
   />Quiero gestionarla yo</label>
                         <label><input type="checkbox" name="ch_Como_quiere_gestionar_su_web_2" value="Quiero que sea estatica, la información se cambiara 1 o 2 veces al año." <?php echo $_smarty_tpl->tpl_vars['recChbx']->value['ch_Como_quiere_gestionar_su_web_2'];?>
  />Quiero que sea estatica, la información se cambiara 1 o 2 veces al año.</label>
   ...
   /> Quiero que me la gestione JNACHER estudio.</label>                   
                   ...
                   <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////-->
                    ...
                    <div class="presupuesto_pasos_right_fila">
                        ...
                        <div class="bg_email_telefono">
                        <label><input type="checkbox" <?php echo $_smarty_tpl->tpl_vars['recChbx']->value['ch_Resolución_de_la_pantalla_1'];?>
 name="ch_Resolución_de_la_pantalla_1" value="Ordenador" />Ordenador</label>
                        <label><input type="checkbox" <?php echo $_smarty_tpl->tpl_vars['recChbx']->value['ch_Resolución_de_la_pantalla_2'];?>
 name="ch_Resolución_de_la_pantalla_2" value="Movil" />Movil</label>
                        <label><input type="checkbox" <?php echo $_smarty_tpl->tpl_vars['recChbx']->value['ch_Resolución_de_la_pantalla_3'];?>
 name="ch_Resolución_de_la_pantalla_3" value="Tableta" />Tableta</label>
                        <label><input type="checkbox" <?php echo $_smarty_tpl->tpl_vars['recChbx']->value['ch_Resolución_de_la_pantalla_4'];?>
 name="ch_Resolución_de_la_pantalla_4" value="Cualquier pantalla" />Cualquier pantalla</label>
                        </div>
                    </div>
                    </div>
 ...
 name="ch_Linea_cromatica_20" value="Otros" />Otros</label>
  ...
  name="ch_Linea_creativa_3" value="Seria-Formal"/>Seria-Formal</label>                        
                   ...
                   <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////-->
                    ...
                    <div class="presupuesto_pasos_right_fila">
                        <div class="presupuesto_campo">
                        <h1>15. Identidad corporativa</h1>
...
/>Quiero reediseñar mi imagen</label>
 ...
 />No tengo nada</label> 
                   ...
                   <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////-->
                    ...
                    <div class="presupuesto_pasos_right_fila">
                        <div class="presupuesto_campo">
                        <h1>16. ¿Tiene un presupuesto designado para este proyecto? </h1>
                   ...
                   <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////-->
                    ...
                    <div class="presupuesto_pasos_right_fila">
                        <div class="presupuesto_campo">
                        <h1>17. ¿Ya tiene un presupuesto de otra empresa? </h1>
                   ...
                   <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////-->
                    ...
                    <div class="presupuesto_pasos_right_fila">
                        <div class="presupuesto_campo">
                        <h1>18. Agregue cualquier aclaración de utilidad para la elaboración del presupuesto.</h1>
