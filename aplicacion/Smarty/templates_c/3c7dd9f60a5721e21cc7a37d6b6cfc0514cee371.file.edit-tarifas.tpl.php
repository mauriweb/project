<?php /* Smarty version Smarty-3.1.12, created on 2014-01-18 12:30:16
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/edit-tarifas.tpl" */ ?>
<?php /*%%SmartyHeaderCode:32043043852a9c6168137e3-97941323%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c7dd9f60a5721e21cc7a37d6b6cfc0514cee371' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/pruebacinco/plantillas/tpl/admin/edit-tarifas.tpl',
      1 => 1390044615,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32043043852a9c6168137e3-97941323',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_52a9c6168652a4_38835508',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a9c6168652a4_38835508')) {function content_52a9c6168652a4_38835508($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="page-container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Editar tarifas <small> Acero estudio</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">Editar tarifas</div>
						</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control" name="category" class="select2me">
                                            	<option value="ES">Delineación</option>
                                                <option value="ES">Diseño gráfico</option>
                                                <option value="ES">Topografía</option>
                                                <option value="ES">Informática</option>
											</select>
										</div>
									</div>
                                    <div class="form-group">
										<label class="control-label col-md-3">Código</label>
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="C0450">
													</div>
									</div>
                                    <div class="form-group">
