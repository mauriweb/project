						...
						<div class="portlet-body"><form id="filtro" method="post" action="gastos">
                            ...
                            <div class="row">
                            	<div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                        <input class="form-control date-picker" placeholder="Fecha de" size="5" type="text" name="fechaDe" value="{$fechaDe}" />
                                        </div>
                                        <div class="col-md-2">
                                     ...
                                     <div class="col-md-12" style="margin-top:5px;">
                                        ...
                                        <div class="col-md-2">
                                        <input class="form-control date-picker" placeholder="Fecha a" size="5" type="text" name="fechaA" value="{$fechaA}" />
                                        </div>
                                        <div class="col-md-2">
