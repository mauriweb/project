                            ...
                            {$idProy}
                                ...
                                {$mensaje}
                                    ...
                                    <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
														<input type="text" class="form-control" placeholder="ej: 7401-DD-Kenya" name="frm-codigo" value="{$data.codigo}">
													</div>
									</div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" maxlength="200" name="frm-observaciones" value="{$data.observaciones}" id="maxlength_placement">
