								...
								<div class="form-body">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">Código</label>
													<div class="col-md-4">
														<input type="text" class="form-control" name="frm-codigo" value="{$data.codigo}" placeholder="C0450">
													</div>
									</div>
                                    <div class="form-group">
										<label class="control-label col-md-3">Descripción</label>
										<div class="col-md-9">
											<input type="text" class="form-control" maxlength="100" name="frm-descripcion" value="{$data.descripcion}" id="maxlength_placement">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">€</label>
													<div class="col-md-4">
														<input type="text" name="frm-euros" value="{$data.euros}" class="form-control" placeholder="000">
													</div>
									</div>
								</div>
