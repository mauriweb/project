                                ...
                                {$mensaje}
                                	<div class="form-group">
                                     ...
                                     <div class="form-group rangos" style="display:none;">
													...
													<div class="col-md-4">
														<input type="text" class="form-control rangos" name="frm-numImpresiones" value="{$frmnumimpresiones}" >
													...
													<div class="col-md-4">
                                                        ...
                                                        <input type="text" class="form-control rangos" name="frm-precioImpresiones" value="{$frmpreciopresiones}" >
													</div>
									</div>
                                    ...
                                    <div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="frm-codigo" value="{$frmcodigo}" placeholder="C000">
													</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" maxlength="150" name="frm-sector" value="{$frmsector}" id="maxlength_placement">
