						...
						<div class="portlet-body"><form method="post" action="partes-de-material" id="filtro">
                            ...
                            <div class="row">
                            	...
                            	<div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                        <input class="form-control date-picker" placeholder="Fecha de" name="fechaDe" value="{$fechaDe}" size="5" type="text" value="" />
                                        </div>
                                        <div class="col-md-2">
                                     ...
                                     <div class="col-md-12" style="margin-top:5px;">
                                        ...
                                        <div class="col-md-2">
                                        <input class="form-control date-picker" placeholder="Fecha a" name="fechaA" value="{$fechaA}" size="5" type="text" value="" />
                                        </div>
                                        <div class="col-md-2">
